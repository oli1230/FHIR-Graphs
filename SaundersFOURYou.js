...
function componentBarsMultiSeries () {
	...
	/* Default Properties */
	var dimensions = { x: 40, y: 40, z: 40 };
	var colors = ["orange", "orange", "yellow", "green", "green"];
				...
				var colorFaceSet = function colorFaceSet(data) {
					return data.map(function (X) {
						return X.values.map(function (d) {
							...
							return '' + Math.round(col.y / 2.55) / 100 + ' ' + Math.round(col.o / 2.55) / 100 + ' ' + Math.round(col.b / 2.55) / 100;
						});
					});
				};
